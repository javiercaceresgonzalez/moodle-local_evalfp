...
/**
 * Dynamic weight totals for EvalFP weighting pages.
 *
 * @module     local_evalfp/weights
 * @copyright  2026 Javier Caceres Gonzalez <javiercaceresgonzalez@gmail.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
define([], function() {
    const inputSelector = '[data-local-evalfp-weight-input]';
    const totalSelector = '[data-local-evalfp-weight-total]';
    ...
    /**
     * Updates every total badge inside a form.
     *
    ...
    const updateForm = form => {
        ...
        form.querySelectorAll(totalSelector).forEach(totalNode => {
